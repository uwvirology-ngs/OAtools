...
[![](https://img.shields.io/badge/devel%20version-0.99.12-purple.svg)](https://github.com/uwvirology-ngs/OAtools)
...
To invoke the built-in Shiny GUI for running OAtools, run the following in the 
R console: 

```r
shiny::runApp(buildApp())
```
