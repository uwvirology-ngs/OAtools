...
```{r interop-NormqPCR_setup, message=FALSE}
...
Then, to convert the SummarizedExperiment container into a *NormqPCR*-friendly instance of the qPCRBatch class, simply invoke the `se_to_qPCRBatch()` function
...
as.data.frame(Biobase::exprs(norm)) |> 
    dplyr::select(`Positive Control`:`Sample-106`) |> 
