...
If we intend to use the relative threshold analysis native to the instrument software, we can generate a run result report directly. This line should generate a .html report and save to the current directory.
